 ...
 */
class getClubRepositoryService extends App_KernelProDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ClubRepository.php';

        return $container->privates['App\\Repository\\ClubRepository'] = new \App\Repository\ClubRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
