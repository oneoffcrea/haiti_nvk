...
class getRouting_LoaderService extends App_KernelProDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\Routing\AttributeRouteControllerLoader('pro');

        $a->addLoader(new \Symfony\Component\Routing\Loader\XmlFileLoader($b, 'pro'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\YamlFileLoader($b, 'pro'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\PhpFileLoader($b, 'pro'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\GlobFileLoader($b, 'pro'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\DirectoryLoader($b, 'pro'));
