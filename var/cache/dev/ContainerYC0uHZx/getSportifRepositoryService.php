 ...
 */
class getSportifRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SportifRepository' shared autowired service.
     *
     * @return \App\Repository\SportifRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SportifRepository.php';

        return $container->privates['App\\Repository\\SportifRepository'] = new \App\Repository\SportifRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
